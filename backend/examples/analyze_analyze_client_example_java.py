...
class JavaLineageAPIClient:
    ...
    def analyze_query(self, source_code: str, model_name: str = "gpt-4o-mini", 
                     agent_name: str = "java") -> Dict[str, Any]:
        """
        Analyze a single Java query using the java_lineage_agent plugin
        
        Args:
            source_code: Java query to analyze
...
def main():
    ...
    print("Analyzing Java query...")
    lineage_result = client.analyze_query(
        source_code=sample_query,
        agent_name="java-lineage-agent"
    )
    print(f"Java lineage agent result: {json.dumps(lineage_result, indent=2)}")
    print()
