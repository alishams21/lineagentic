...
def create_airflow_lineage_agent(agent_name: str, source_code: str, model_name: str = "gpt-4o-mini") -> AirflowLineageAgent:
    """Factory function to create a AirflowLineageAgent instance"""
    return AirflowLineageAgent(agent_name=agent_name, source_code=source_code, model_name=model_name)
