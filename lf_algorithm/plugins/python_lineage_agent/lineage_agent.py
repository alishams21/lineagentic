...
def create_python_lineage_agent(agent_name: str, source_code: str, model_name: str = "gpt-4o-mini") -> PythonLineageAgent:
    """Factory function to create a PythonLineageAgent instance"""
    return PythonLineageAgent(agent_name=agent_name, source_code=source_code, model_name=model_name)
