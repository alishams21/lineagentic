...
def create_java_lineage_agent(agent_name: str, source_code: str, model_name: str = "gpt-4o-mini") -> JavaLineageAgent:
    """Factory function to create a JavaLineageAgent instance"""
    return JavaLineageAgent(agent_name=agent_name, source_code=source_code, model_name=model_name)
